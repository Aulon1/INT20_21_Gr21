...
.LAJMET img{
  ...
  <?php include('./views/header.php')  ?>
    <div class="LAJMET">
    <main>
<h1>Joe Biden fiton zgjedhjet presidenciale në SHBA</h1>
<p>
